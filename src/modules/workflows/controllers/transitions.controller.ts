...
export class TransitionsController {
    ...
    @ApiQuery({ name: 'filter[pasoOrigen.id]', required: false, description: 'Filtrar por ID del Paso Origen' })
    @ApiQuery({ name: 'filter[pasoDestino.id]', required: false, description: 'Filtrar por ID del Paso Destino' })
