...
describe('CompaniesService', () => {
    ...
    describe('create', () => {
        it('should create a company', async () => {
            const createDto: CreateCompanyDto = { nombre: 'Test Company', estado: 1 };
            const savedCompany = { id: 1, ...createDto, fechaCreacion: new Date() };

            (repository.findOne as jest.Mock).mockResolvedValue(null);
            (repository.create as jest.Mock).mockReturnValue(savedCompany);
